  ...
  <ContentCard class="justify-content-center">
    <div class="col-12 col-md-8 p-5">
      <p class="text-justify">
        ...
        colleagues and friends from Prague make fun of it and I am fine with
      ...
      <p class="text-justify">
        ...
        because I suck at it. This site might be my masterpiece (thanks
        to Bootstrap 😅).
      </p>

      <p class="text-justify">
        I started this project during my sabbatical to learn Vue. Yes, it is a
